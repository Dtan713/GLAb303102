public class myRunner {
    public static void main(String[] args) {
        ...
        Shape s0bj = new Shape();
        s)s0bj.displayshapName();
        System.out.println(s0bj instanceof Shape); // true

        // object creation of he Circle class
        System.out.println("++++++++";);
        ...
        System.out.println(s0bj instanceof Circle); //false because shape is not a
